...
protocol ZoneKitDeviceDelegate: AnyObject {
...
class ZoneKitDevice: NSObject {
    ...
    weak var delegate: ZoneKitDeviceDelegate?
    ...
    private var orientation: ZoneKitOrientation = .portrait
    
    // MARK: - Initialization

    init(device: AVCaptureDevice, delegate: ZoneKitDeviceDelegate) {
        self.device = device
    ...
    private func createCaptureSource(from device: AVCaptureDevice) -> ZoneKitSource {
        // Determine the source type based on device characteristics
        let sourceType: ZoneKitSourceType
    ...
    private func setupVideoDataOutput() {
        let pixelFormat: ZoneKitPixelFormat = .rgb
...
extension ZoneKitDevice: AVCaptureVideoDataOutputSampleBufferDelegate, AVCaptureAudioDataOutputSampleBufferDelegate {
...
extension AVCaptureDevice {
    ...
    func updateFormat(with preferredSpec: ZoneKitVideoSpec) {
